...
- SHOW CORE ELEMENTS: MAP, AGE PLOT, TERM LENGTH PLOT

- SHOW UI FEATUERS: SELECT INPUT AND REACTIVE UPDATED SELECT INPUT

- SHOW UI FEATURES: EXPORT OPTIONS

- SHOW HOW WEBSITE/DASHBOARD IS INTRODUCED IN A VERY APPROACHABLE WAY
...
- ADD IMAGES OF CHANGING CONSTITUENCIES

- ADD IMAGES / SHOW SCREENSHOTS OF MERGE PROBLEMS DUE TO DIFFERENT CONSTITUENCY NAMES (MISTAKES)
